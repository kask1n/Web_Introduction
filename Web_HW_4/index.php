<!-- Задача 4.1:
На основе верстки из документа cv.html, необходимо создать php-файл с названием index.php и вставить в этот сайт все что есть в html-документе.
...
<?php
$job = [
    'job_name' => ['GB', 'Freelance', 'Yandex'],
    'job_data' => ['2023 - now', '2021 - 2022', '2019 - 2020'],
